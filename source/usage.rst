...
Описание этих и других shortcuts в документации разработчиков:
...
(Такое поведение можно отменить в Options->Preferences->Editor) или вариант перевода
из окна fuzzy match.
...
что вы не хотите, нужно это удалить, иначе это сохранится при переходе в другой сегмент или другом действи.
